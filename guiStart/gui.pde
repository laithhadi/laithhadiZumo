...
public void stopCAction(GButton source, GEvent event) { //_CODE_:stopC:208276:
   myPort.write('f');
   showCommands.setText("Stopped at side-corridor");
} //_CODE_:stopC:208276:
...
public void createGUI(){
  ...
  stopC = new GButton(this, 321, 120, 104, 30);
  stopC.setText("Stop at Corridor");
  stopC.setTextBold();
  stopC.addEventHandler(this, "stopCAction");
}
